...
/** Root of the Test Reviewer benchmark fixture tree — see `tests/test-reviewer-benchmarks/README.md`. */
export const BENCHMARK_ROOT = path.resolve(process.cwd(), "tests/test-reviewer-benchmarks");
