...
/**
 * Failure-reason taxonomy for the Test Reviewer benchmark — same design
 * as `code-benchmarks/baseline/failure-analysis.ts`. A fixture can
 * carry more than one reason at once.
 */
