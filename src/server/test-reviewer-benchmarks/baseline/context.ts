 ...
 * specialist reviewer, from a Test Reviewer benchmark fixture's full
 * source files. Identical in design to the other four benchmarks'
 * `baseline/context.ts` (see `code-benchmarks/baseline/context.ts`'s
...
export function buildReviewContextFromFixture(fixture: LoadedFixture): ReviewContext {
  ...
  return {
    pullRequestTitle: `[test-reviewer-benchmark] ${fixture.manifest.fixture_id}`,
