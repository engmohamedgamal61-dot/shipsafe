...
import { TestReviewerAgent } from "@/server/review-engine/agents/test-reviewer";
...
/**
 * Invokes the CURRENT, unmodified production `TestReviewerAgent` +
 * `AnthropicProvider` — identical in design to the other four
...
export async function runFixtureLive(fixture: LoadedFixture, agent: TestReviewerAgent): Promise<BaselineFixtureRun> {
