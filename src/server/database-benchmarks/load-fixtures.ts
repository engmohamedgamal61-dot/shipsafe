...
/** Root of the Database Reviewer benchmark fixture tree — see `tests/database-benchmarks/README.md`. */
export const BENCHMARK_ROOT = path.resolve(process.cwd(), "tests/database-benchmarks");
